...
public typealias ChatChannelList = ChatChannelListVC._ChatChannelList<NoExtraData>

extension _ChatChannelListVC {
    /// A `UIViewControllerRepresentable` subclass which wraps `ChatChannelListVC` and shows list of channels.
    public struct _ChatChannelList<ExtraData: ExtraDataTypes>: UIViewControllerRepresentable {
